...
namespace Medius.DummyERP.Platform.MasterDataImportHandler
{
    ...
    public class CurrencyRateImport : SPCSImportHandlerBase, IMasterDataHandler
    {
        public override Core.Entities.MasterData CreateNewInstance()
        {
            return new Medius.Core.Entities.CurrencyRate();
        }
        ...
        public override System.Type MasterDataType
        {
            get
            {
                return typeof(Medius.Core.Entities.CurrencyRate);
            }
        }
    }
}
